...
var genesisTXID = '62d496378e5834989dd9594cfc168dbb76f84a39bbda18286cddc7d1d1589f4f';
var CONCURRENCY = 10;
...
var encodedData = require('soop').load('mazacore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('mazacore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('mazacore/lib/Address', {
